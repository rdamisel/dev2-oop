            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="units" id="units" class="form-control" max="23"
                            placeholder="Maximum of 23">
                    </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    <div class="border p-2">
                        <p>Student Name: <span class="fw-bold">
                                <?= $name ?>
                            </span></p>
                        <p>Year Level: <span class="fw-bold">
                                <?= $year_level ?>
                            </span></p>
                        <p>No. of units: <span class="fw-bold">
                                <?= $units ?>
                            </span></p>
                        <p class="fw-bold">Total Price:
                            <?= $total_price ?> <span class="fst-italic"> (
                                <?= $school->getLab() ?>)
                            </span>
                        </p>
                    </div>
